...
public class FragmentPopular extends Fragment {
    ...
    public final static String TAG = "FragmentPopular";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            if(dealsInfoDAO.getDealDataByName("Popular").size()>0)
            {
                try
                {
                    JSONArray data = new JSONArray(dealsInfoDAO.getDealDataByName("Popular").get(0).getDealResponse());
                    if(data.length()>0)
                    {
                        dataOK();
    ...
    {
        Log.e("for page pop",":"+page);
        final String url = "https://stagingapi.desidime.com/v3/deals.json?type=popular&deal_view=true&per_page=10&page="+page;
                    ...
                    public void onResponse(String response) {
                        ...
                        try
                        {
                            ...
                            if(page == 1)
                            {
                                ...
                                {
                                    dataOK();
                                    dealsInfoDAO.insertOrUpdateDeal(new DealsInfoModel("Popular",data.toString()));
       ...
       if(page == 1)
       {
        ...
        volleyRequest.addToRequestQueue(postRequest, "popular");
    }
